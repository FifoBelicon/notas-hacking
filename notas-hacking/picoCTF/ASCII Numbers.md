...
En este caso nos dan una cadena de caracteres en hexadecimal, en el cual nos pide que obtengamos su equivalencia en el codigo ASCII.

Para esto usamos la herramienta `CyberChef`
- Lo configuramos con la opcion `FromHex`
- Le pasamos los caracteres dados por el reto y obtenemos la flag:
